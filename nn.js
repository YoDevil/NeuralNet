class NeuralNetwork {
    constructor(){
        ...
        this.outputLayer.initWeights(arguments[arguments.length-1]);
        this.outputLayer.initBiases(arguments[arguments.length-1]);
    }
...
class Layer {
    ...
    initBiases(activation){
        for(let i=0; i<this.biases.length; i++){
            this.biases[i] = (activation == "relu") ? 0.1 : 0;
        }
    }
